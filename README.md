...
## Configuration
This project configuration is very simple, using Maven as dependency control. Specific information can be found in pom.xml
```
...
## [API](#API)
```
ip:port/user/info GET   togetImuserInfo
```
